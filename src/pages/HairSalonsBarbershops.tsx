      ...
      <section className="py-24 bg-gradient-to-br from-gray-100 via-white to-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-xl text-brand-gray max-w-3xl font-alice">
            Fill your chairs consistently with our local marketing strategy designed specifically for hair salons and barbershops.
          </p>
        </div>
      </section>
...
export default HairSalonsBarbershops;